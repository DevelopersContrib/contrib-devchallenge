        ...
        <div className="px-10 mx-auto max-w-7xl">
            <div className="relative flex items-center justify-between h-20 mx-auto">
                ...
                <nav className="text-sm font-bold text-white sm:text-base">
                    <a href="/" className="relative inline-block px-0 pb-1 mr-2 group sm:mr-4">
                        <span>Home</span>
                    ...
                    <a href="https://discord.gg/h4Cm9q7w" target="_blank" className="relative inline-block px-0 pb-1 mr-2 group sm:mr-4">
                        <span>Community</span>
                        <span className="h-0.5 w-full absolute bottom-0 opacity-0 group-hover:opacity-100 transition ease-out duration-200 translate-y-1 group-hover:-translate-y-0 left-0 bg-white"></span>
                    </a>
					 <a href="https://blog.devchallenge.com" target="_blank" className="relative inline-block px-0 pb-1 mr-2 group sm:mr-4">
                        <span>Blog</span>
                        <span className="h-0.5 w-full absolute bottom-0 opacity-0 group-hover:opacity-100 transition ease-out duration-200 translate-y-1 group-hover:-translate-y-0 left-0 bg-white"></span>
                    </a>
                    <a href="/templates" className="relative inline-block px-0 pb-1 mr-2 group sm:mr-4">
                        <span>Templates</span>
                        <span className="h-0.5 w-full absolute bottom-0 opacity-0 group-hover:opacity-100 transition ease-out duration-200 translate-y-1 group-hover:-translate-y-0 left-0 bg-white"></span>
                    </a>
					 ...
					 <a href="/contact" className="relative inline-block px-0 pb-1 mr-2 group sm:mr-4">
